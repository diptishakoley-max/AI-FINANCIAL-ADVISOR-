...
def split_advice_sections(advice_text):
    ...
    pattern = r"(Current Financial Health:|Existing Savings Utilization:|Monthly Savings Strategy:|Debt Plan:|Investment Advice:|Investment Allocation:|Goal Guidance:|Budgeting & More:|Budgeting Tips:)"
...
def split_goal_sections(goal_text):
    ...
    pattern = r"(Financial Impact Analysis:|Revised Goal Timeline:|Monthly Action Plan:|Resource Allocation Strategy:|Risk Assessment & Mitigation:|Progress Tracking Framework:|Contingency Planning:|Key Success Metrics:|Next Immediate Actions:|Instruction Implementation Strategy:)"
